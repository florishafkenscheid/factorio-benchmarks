...
const PATHS = {
    ...
    METRIC_CORRELATIONS_OUTPUT: "./metric_correlations_on_patch.csv",
    METRIC_TO_ENTITY_OUTPUT: "./design_metrics_and_key_entities.csv",
    ENTITY_COUNT_REPORT: "../blueprints/maps/aggregate.csv"
}

const designInfo = [
    { designName: "00_baseline", on_patch: false, map_gen: 100 },
    { designName: "01_geist", on_patch: false, map_gen: 100 },
    { designName: "02_geist", on_patch: true, map_gen: 100 },
    { designName: "03_swiftdeath007", on_patch: false, map_gen: 100 },
    { designName: "04_goirelandbrad", on_patch: false, map_gen: 100 },
    { designName: "05_flexime", on_patch: false, map_gen: 100 },
    { designName: "06_mulain", on_patch: true, map_gen: 100 },
    { designName: "07_rydberg", on_patch: true, map_gen: 600 },
    { designName: "08_derantrix", on_patch: false, map_gen: 100 },
    { designName: "09_azhrei", on_patch: false, map_gen: 100 },
    { designName: "10_thaeln", on_patch: true, map_gen: 600 },
    { designName: "11_thaeln", on_patch: true, map_gen: 200 },
    { designName: "13_yuu", on_patch: true, map_gen: 600 },
    { designName: "14_redphoenixq", on_patch: false, map_gen: 100 },
    { designName: "15_yoyonas", on_patch: false, map_gen: 100 },
    { designName: "16_teaz", on_patch: true, map_gen: 100 },
    { designName: "17_akaravortex", on_patch: false, map_gen: 100 },
    { designName: "18_akaravortex", on_patch: false, map_gen: 100 },
    { designName: "19_akaravortex", on_patch: true, map_gen: 100 },
    { designName: "20_groot_opperhoofd", on_patch: false, map_gen: 100 },
    { designName: "21_em", on_patch: false, map_gen: 100 },
    { designName: "22_warbaque", on_patch: false, map_gen: 100 },
    { designName: "23_warbaque", on_patch: false, map_gen: 100 },
    { designName: "24_syvkal", on_patch: false, map_gen: 100 },
    { designName: "25_mcmayhem57", on_patch: false, map_gen: 100 },
    { designName: "26_galacta487", on_patch: false, map_gen: 100 },
    { designName: "27_theflyingcurryfish154", on_patch: true, map_gen: 200 },
    { designName: "28_erichteia", on_patch: true, map_gen: 100 },
    { designName: "29_the_end", on_patch: true, map_gen: 600 },
].map(it => ({ ...it, speed: 1 }))
// .filter(it => it.on_patch == false && it.designName != "00_baseline")
.filter(it => it.on_patch == true && it.designName != "13_yuu" && it.designName != "16_teaz")
