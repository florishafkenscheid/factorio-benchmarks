...
const designTags = [
    { designName: "red_360_abucnasty", speed: 360 },
    { designName: "red_360_geist", speed: 360 },
    { designName: "red_360_henryjk", speed: 360 },
    { designName: "red_360_lady_meyneth", speed: 360 },
    { designName: "red_360_phlap", speed: 360 },
    { designName: "red_360_thaeln", speed: 360 },
    { designName: "red_360_undertow", speed: 360 },
]
...
async function getEntityCountsByDesign() {
    ...
    const max_speed = Math.max(...designTags.map(it => it.speed))
...
const main = async () => {
    ...
    designs.forEach(design => {
        ...
        const designInfo = designTags.find(it => it.designName == design)
        assert(designInfo !== undefined, `design ${design} not found`)
