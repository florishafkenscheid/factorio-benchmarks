...
#     --max-ticks 16 `
#     --aggregate-strategy "average" `
#     -o "charts/summary_run_distribution_chests.png" `
#     --trim-prefix "bm_"
...
# belt-charts "results/bm_wood*.csv" `
#     -w 1400 `
#     -h 800 `
#     --type "bar" `
#     --remove-first-ticks 1 `
...
belt-charts "results/bm_*{chest,car_1}*.csv" `
    -w 1300 `
    -h 800 `
    --type "summary" `
    --remove-first-ticks 1 `
    -o "charts/summary_verbose_metrics_1_1_table.png" `
    --aggregate-strategy "average" `
    --trim-prefix "bm_" `
    --max-ticks 16 `
    --metrics "wholeUpdate,controlBehaviorUpdate,transportLinesUpdate,electricHeatFluidCircuitUpdate,electricNetworkUpdate,fluidFlowUpdate,entityUpdate,trains" `
